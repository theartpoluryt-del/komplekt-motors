...
const brandCertificates = Object.fromEntries(brands.map((brand) => [brand, [
  {
    title: `${brand}: сертификаты и подтверждающие документы`,
    type: "Комплект документов",
    url: null,
    note: "Открывается как список документов для поставок. Фактические PDF/сканы можно заменить после загрузки на сайт."
  },
  {
    title: "Паспорта качества партий",
    type: "Паспорт качества",
    url: null,
    note: "Паспорт качества предоставляется по конкретной партии, фасовке и дате поставки."
  },
  {
    title: "Декларации соответствия и SDS/MSDS",
    type: "Безопасность и соответствие",
    url: null,
    note: "Документы по безопасности и соответствию запрашиваются для выбранного продукта."
  }
]]));

brandCertificates.Repsol.unshift({
  title: "Сертификат официального дилера REPSOL",
  type: "Дилерский сертификат",
  url: "https://kmo74.ru/uploads/page/1/6538916732_2023-10-14_22-34-50.webp",
  note: "Сертификат со старого сайта Комплект-Моторс."
});
...
const ozonCatalogProducts = [
  ...
  {
    "name": "Масло трансмиссионное полусинтетическое KANSLER Hypoid SHC 75W90 1литр",
    "brand": "Kansler",
    "category": "transmission",
    "description": "Трансмиссионное масло из каталога Ozon Комплект-Моторс. Совместимость с узлом и допуски уточняются в карточке Ozon.",
    "image": "assets/product-placeholder.svg",
    "ozonUrl": "https://www.ozon.ru/product/maslo-transmissionnoe-polusinteticheskoe-kansler-hypoid-shc-75w90-1litr-2768739345/",
    "source": "ozon"
  },
  {
    "name": "Масло трансмиссионное синтетическое KANSLER Hypoid SHC 75W90 1литр",
    "brand": "Kansler",
    "category": "transmission",
    "description": "Трансмиссионное масло из каталога Ozon Комплект-Моторс. Совместимость с узлом и допуски уточняются в карточке Ozon.",
    "image": "assets/product-placeholder.svg",
    "ozonUrl": "https://www.ozon.ru/product/maslo-transmissionnoe-sinteticheskoe-kansler-hypoid-shc-75w90-1litr-2762241755/",
    "source": "ozon"
  },
  {
  ...
  {
    "name": "Трансмиссионное масло Kansler Hypoid GL4/5 SAE 75W90, 20л",
    "brand": "Kansler",
    "category": "transmission",
    "description": "Трансмиссионное масло из каталога Ozon Комплект-Моторс. Совместимость с узлом и допуски уточняются в карточке Ozon.",
    "image": "assets/product-placeholder.svg",
    "ozonUrl": "https://www.ozon.ru/product/transmissionnoe-maslo-kansler-hypoid-gl4-5-sae-75w90-20l-1902102386/",
    "source": "ozon"
  },
  {
    "name": "Трансмиссионное масло Kansler Hypoid HD 80W90, 20л",
    "brand": "Kansler",
    "category": "transmission",
    "description": "Трансмиссионное масло из каталога Ozon Комплект-Моторс. Совместимость с узлом и допуски уточняются в карточке Ozon.",
    "image": "assets/product-placeholder.svg",
    "ozonUrl": "https://www.ozon.ru/product/transmissionnoe-maslo-kansler-hypoid-hd-80w90-20l-1902100148/",
    "source": "ozon"
  },
  {
  ...
  {
    "name": "KANSLER 10W-40 Масло моторное, Полусинтетическое, 20 л",
    "brand": "Kansler",
    "category": "elite",
    "description": "Товар из каталога Ozon Комплект-Моторс для легкового транспорта. Подробные характеристики и применимость указаны в карточке Ozon.",
    "image": "assets/product-placeholder.svg",
    "ozonUrl": "https://www.ozon.ru/product/kansler-10w-40-maslo-motornoe-polusinteticheskoe-20-l-1899518010/",
    "source": "ozon"
  },
  {
    "name": "KANSLER 5W-40 Масло моторное, Синтетическое, 20 л",
    "brand": "Kansler",
    "category": "elite",
    "description": "Товар из каталога Ozon Комплект-Моторс для легкового транспорта. Подробные характеристики и применимость указаны в карточке Ozon.",
    "image": "assets/product-placeholder.svg",
    "ozonUrl": "https://www.ozon.ru/product/kansler-5w-40-maslo-motornoe-sinteticheskoe-20-l-1899544510/",
    "source": "ozon"
  },
  {
    ...
    <head>
      ...
      <style>
        ...
        * { box-sizing:border-box; }
        ...
        header { display:flex; align-items:center; justify-content:space-between; gap:20px; padding:18px clamp(18px,4vw,56px); color:#fff; background:#0f0f0f; }
        ...
        .hero { padding:34px; color:#fff; border-radius:var(--radius); background:#0f0f0f; }
        ...
        button { color:#fff; border:1px solid rgba(255,255,255,.42); background:transparent; cursor:pointer; }
